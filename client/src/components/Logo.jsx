/**
 * The id3a wordmark, inlined as SVG so it can take its color from the parent
 * (uses `currentColor` for fills). Set height; width is derived from the
 * 150:70 viewBox aspect.
 *
 *   <Logo height={24} className="text-white" />
 */
export default function Logo({ height = 24, className = '', ...rest }) {
  return (
    <svg
